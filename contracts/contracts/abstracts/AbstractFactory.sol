    ...
    Pausable
{
     ...
     * @param token : Token contract as base contribution.
    ...
    function _setUp(
        ...
        data.setContractData(token, feeTo, serviceRate, safe);
    }
    ...
    */
        ...
        returns (uint)
    {
        ...
        CreatePoolParam memory cpp = CreatePoolParam(intRate, quorum, durationInHours, colCoverage, unitLiquidity, contributors);
        emit PoolCreated(
  ...
  */
    ...
    */
    ...
    function setContractData(
        ...
        returns(bool)
    {
        return data.setContractData(token, feeTo, serviceRate, safe);
    }
